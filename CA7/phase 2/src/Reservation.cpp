...
double Reservation::getSingleRoomPrice()
{
    return hotel->getPrices()[roomType];
}
...
double Reservation::getRoomsPrices()
{
    return bookedRooms.size() * hotel->getPrices()[roomType];
}
int Reservation::getQuantity()
{
